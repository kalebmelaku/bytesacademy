...
function Contact() {
	return (
		<section class="text-gray-600 container md:mx-auto " id="contact">
			<p className="text-center text-4xl font-bold">Get In Touch With Us</p>
			<div
				class="flex flex-col md:items-center md:flex-row lg:max-w-7xl w-full px-5 py-6 md:py-12 mx-auto section "
			...
			>
				<div class="md:w-1/3 w-full justify-center">
					<p class="leading-relaxed text-xl text-gray-900">
						...
						<Link
							...
							class="font-semibold border-b-4 border-primary"
						>
				...
				<div class="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
					<h1 class="text-xl text-gray-800 sm:text-xl font-bold title-font mb-4">
						Fill out this form
					</h1>
					<form
					...
					>
						...
						<div class="p-2 w-full">
							<button
								type="submit"
								class="flex text-black bg-primary border-0 py-4 px-6 focus:outline-none hover:bg-secondary rounded text-xl font-bold shadow-lg mx-0 flex-col text-center g-recaptcha"
							>
								Send Message ✉
							</button>
						</div>
